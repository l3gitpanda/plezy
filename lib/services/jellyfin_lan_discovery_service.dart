...
class JellyfinLanDiscoveryService {
  ...
  Future<List<DiscoveredJellyfinServer>> discover({
    ...
    try {
      ...
      socketSet.listen((datagram) {
        ...
        final server = parseDiscoveryResponse(datagram.data, dialect: dialect, sourceAddress: datagram.address);
  ...
  static DiscoveredJellyfinServer? parseDiscoveryResponse(
    List<int> data, {
    required MediaBrowserDialect dialect,
