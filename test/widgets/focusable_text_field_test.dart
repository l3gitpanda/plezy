...
void main() {
  ...
  testWidgets('TV engine-synthesized select is handled by the virtual keyboard', (tester) async {
  ...
  testWidgets('TV text field handles physical keyboard text editing through virtual keyboard', (tester) async {
    TvDetectionService.debugSetTvOverride(true);
    await _setTvSurfaceSize(tester);
    final controller = TextEditingController();
    final fieldFocusNode = FocusNode(debugLabel: 'search_field');
  ...
  testWidgets('Apple TV multiline field opens the custom keyboard instead of the native channel', (tester) async {
