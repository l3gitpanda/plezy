...
MediaItem _item(String id, MediaKind kind, {String? parentId, String? grandparentId, int? index}) =>
    MediaItem.plex(id: id, kind: kind, title: id, parentId: parentId, grandparentId: grandparentId, index: index);
...
class _FakeClient implements MediaServerClient {
  ...
  Future<({MediaItem? item, MediaItem? onDeckEpisode})> fetchItemWithOnDeck(
    String id, {
    void Function(MediaItem)? onItemReady,
  }) async => (item: itemsById[id], onDeckEpisode: onDeckByShow[id]);
